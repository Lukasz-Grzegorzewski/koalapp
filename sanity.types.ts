...
// Source: ./src/sanity/lib/categories/getAllCategories.ts
...
// Source: ./src/sanity/lib/orders/getOrderByUserId.ts
// Variable: ORDERS_BY_USER_ID_QUERY
// Query: *[_type == "order" && clerkUserId == $userId] | order(orderDate desc) {      ...,      products[]{        ...,        product->      }    }
export type ORDERS_BY_USER_ID_QUERYResult = Array<{
  _id: string;
  _type: "order";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ALL_PRODUCTS_BY_NAME_QUERY
// Query: *[_type == "product"      && name match $searchParam] | order(name asc)
export type ALL_PRODUCTS_BY_NAME_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./src/sanity/lib/sales/getActiveSaleByCoupon.ts
// Variable: GET_ACTIVE_SALE_BY_COUPON_QUERY
// Query: *[      _type == "sale"      && isActive == true      && couponCode == $couponCode    ] | order(validFrom desc)[0]
export type GET_ACTIVE_SALE_BY_COUPON_QUERYResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"product\"\n      && name match $searchParam] | order(name asc)": ALL_PRODUCTS_BY_NAME_QUERYResult;
    "\n    *[\n      _type == \"sale\"\n      && isActive == true\n      && couponCode == $couponCode\n    ] | order(validFrom desc)[0]  \n  ": GET_ACTIVE_SALE_BY_COUPON_QUERYResult;
  }
}
